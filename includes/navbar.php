...
<div class="wrapper row1">
	<header id="header" class="clear">
		...
		<div id="logo">
			<hgroup>
				<h1>
					<a href="index.php">Park Plumbing &amp; Tiling</a>
				</h1>
				<h2>
					<a href="http://www.parkplumb.co.uk">Plumbing &amp; Tiling Services
						South Wales</a>
				</h2>
			</hgroup>
			<div id="facebook">
		...
		<div class="contact_details_large">
			<p>
				Call Now: 07789 711799<br /> Free Quotation
			</p>
		</div>
		<nav class="clear">
			<ul>
